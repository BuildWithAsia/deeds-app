...
// .wrangler/tmp/bundle-Ah4FL9/checked-fetch.js
...
async function handleVerifyDeed(request, env) {
  ...
  const updatedUser = await db.prepare("SELECT id,name,email,credits FROM users WHERE id=?1").bind(deed.user_id).first();
...
// .wrangler/tmp/bundle-Ah4FL9/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-Ah4FL9/middleware-loader.entry.ts
